...
export const MapDetailsProvider = ({ children }) => {
  ...
  const routeMarkers = [
    ...
    { halte: 'Pintu Utara', geoCode: [-6.887737, 107.609306], nextHalteEstimate: 60, wait: 14 },
    { halte: 'Gb. Batan', geoCode: [-6.888668, 107.608160], nextHalteEstimate: 60, wait: 16},
    { halte: 'Gb. Sipil', geoCode: [-6.893580, 107.608821], nextHalteEstimate: 120, wait: 19 },
    { halte: 'Gb. Utama', geoCode: [-6.893182, 107.610355], nextHalteEstimate: 60, wait: 20 },
    ...
    { halte: 'Tomoro', geoCode: [-6.885669, 107.613524], nextHalteEstimate: 120, wait: 4 },    
    ...
    { halte: 'Naskun Kuah', geoCode: [-6.876664, 107.612832], nextHalteEstimate: 120, wait: 19 },    
  ]
